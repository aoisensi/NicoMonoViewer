...
{
	public partial class ThemesDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget NicoMonoViewer.ThemesDialog
			this.Name = "NicoMonoViewer.ThemesDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			this.Resizable = false;
			this.AllowGrow = false;
			// Internal child NicoMonoViewer.ThemesDialog.VBox
			...
			w1.Add (this.comboboxTheme);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(w1 [this.comboboxTheme]));
			w2.Position = 0;
			w2.Expand = false;
			w2.Fill = false;
			// Internal child NicoMonoViewer.ThemesDialog.ActionArea
