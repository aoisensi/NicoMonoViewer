...
namespace NicoMonoViewer
{
	public partial class LoginDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget NicoMonoViewer.LoginDialog
			this.Name = "NicoMonoViewer.LoginDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			this.Resizable = false;
			this.AllowGrow = false;
			// Internal child NicoMonoViewer.LoginDialog.VBox
			...
			w9.Expand = false;
			w9.Fill = false;
			// Internal child NicoMonoViewer.LoginDialog.ActionArea
